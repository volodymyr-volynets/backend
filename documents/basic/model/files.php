...
class numbers_backend_documents_basic_model_files extends object_table {
	...
	public $columns = [
		'dc_file_id' => ['name' => 'File #', 'domain' => 'document_id_sequence'],
		'dc_file_hash' => ['name' => 'Hash', 'domain' => 'document_hash'],
		'dc_file_storage_id' => ['name' => 'Storage #', 'domain' => 'type_id'],
		'dc_file_storage_name' => ['name' => 'Storage Name', 'type' => 'text'],
		'dc_file_thumbnail' => ['name' => 'Thumbnail', 'type' => 'boolean']
	];
	public $constraints = [
		'dc_files_pk' => ['type' => 'pk', 'columns' => ['dc_file_id']],
		'dc_file_hash_un' => ['type' => 'unique', 'columns' => ['dc_file_hash', 'dc_file_storage_id']], // file is unique per storage
