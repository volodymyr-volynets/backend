...
class Employees extends \Object\Table {
	...
	public $title = 'S/M Employees';
	public $name = 'sm_employees';
	public $pk = ['id'];
	public $tenant;
	public $orderby;
	public $limit;
	...
	public $constraints = [
		'sm_employees_pk' => ['type' => 'pk', 'columns' => ['id']],
	];
	public $indexes = [
		'sm_employees_fulltext_simple_idx' => ['type' => 'fulltext', 'columns' => ['first_name', 'last_name']]
	];
