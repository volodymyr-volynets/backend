...
use Numbers\Backend\Db\Test\Model\Employee\Audits;
use Numbers\Backend\Db\Test\Model\Employee\Tenanted;
use Numbers\Backend\Db\Test\Model\Employees;
...
class Base extends TestCase
{
    ...
    {
        $query = Builder::quick($db_object->db_link);
        $query->select();
        $query->columns([
    ...
    public function testTemporaryTable($db_object)
    {
        ...
        $query = Employees::queryBuilderStatic();
