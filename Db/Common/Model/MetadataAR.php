...
class MetadataAR extends \Object\ActiveRecord {
	 ...
	 */
	public ?string $sm_metadata_db_link = null;
	 ...
	 * @var string Domain: code Type: varchar
	 */
	public ?string $sm_metadata_type = null;
	 ...
	 * @var string Domain: code Type: varchar
	 */
	public ?string $sm_metadata_name = null;
	 ...
	 * @var string Domain: code Type: varchar
	 */
	public ?string $sm_metadata_sql_version = null;
}