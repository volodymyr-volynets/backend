...
class ModelsAR extends ActiveRecord
{
     ...
     * @var int|null Type: boolean
     */
    public int|null $sm_model_widget_batches = 0 {
        get => $this->sm_model_widget_batches;
        set {
            $this->setFullPkAndFilledColumn('sm_model_widget_batches', $value);
            $this->sm_model_widget_batches = $value;
        }
    }
     ...
     * @var int|null Type: boolean
     */
    public int|null $sm_model_scoped_attribute = 0 {
        get => $this->sm_model_scoped_attribute;
        set {
            $this->setFullPkAndFilledColumn('sm_model_scoped_attribute', $value);
            $this->sm_model_scoped_attribute = $value;
        }
    }
     ...
     * @var int|null Type: boolean
     */
    public int|null $sm_model_scoped_record = 0 {
        get => $this->sm_model_scoped_record;
        set {
            $this->setFullPkAndFilledColumn('sm_model_scoped_record', $value);
            $this->sm_model_scoped_record = $value;
        }
    }
