...
namespace Numbers\Backend\Configuration\Db\Data;
...
class System extends Import
{
    public $data = [
        'controllers' => [
            ...
            'data' => [
                [
                    'sm_resource_id' => '::id::\Numbers\Backend\Configuration\Db\Controller\ConfigurationValues',
                    'sm_resource_code' => '\Numbers\Backend\Configuration\Db\Controller\ConfigurationValues',
                    'sm_resource_type' => 100,
                    'sm_resource_classification' => 'Settings',
                    'sm_resource_name' => 'S/M Configuration Db Values',
        ...
        'menu' => [
            ...
            'data' => [
                [
                    'sm_resource_id' => '::id::\Menu\Numbers\Backend\Configuration\Db\Controller\ConfigurationValues',
                    'sm_resource_code' => '\Menu\Numbers\Backend\Configuration\Db\Controller\ConfigurationValues',
                    'sm_resource_type' => 200,
                    'sm_resource_name' => 'Configuration Db Values',
                    'sm_resource_description' => null,
                    'sm_resource_icon' => 'far fa-gem',
                    'sm_resource_module_code' => 'SM',
                    'sm_resource_group1_name' => 'Operations',
                    ...
                    'sm_resource_acl_permission' => 1,
                    'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Backend\Configuration\Db\Controller\ConfigurationValues',
                    'sm_resource_menu_acl_method_code' => 'index',
                    'sm_resource_menu_acl_action_id' => '::id::List_View',
                    'sm_resource_menu_url' => '/Numbers/Backend/Configuration/Db/Controller/ConfigurationValues',
                    'sm_resource_menu_options_generator' => null,
                    'sm_resource_inactive' => 0
                ],
            ]
