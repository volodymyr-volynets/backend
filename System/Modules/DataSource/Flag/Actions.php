...
namespace Numbers\Backend\System\Modules\DataSource\Flag;
...
class Actions extends DataSource
{
    ...
    public $primary_model = '\Numbers\Backend\System\Modules\Model\System\Flag\Map';
    public $parameters = [
        'sysflag_id' => ['name' => 'System Flag #', 'domain' => 'resource_id', 'required' => true],
    ];
    ...
    public function query($parameters, $options = [])
    {
        // columns
        $this->query->columns([
            'id' => 'a.sm_sysflgmap_action_id',
            'parent_id' => 'b.sm_action_parent_action_id',
            'name' => 'b.sm_action_name',
            'icon' => 'b.sm_action_icon',
            'disabled' => 'a.sm_sysflgmap_disabled',
            'inactive' => 'a.sm_sysflgmap_inactive + b.sm_action_inactive'
        ]);
        // join
        $this->query->join('INNER', new \Numbers\Backend\System\Modules\Model\Resource\Actions(), 'b', 'ON', [
            ['AND', ['a.sm_sysflgmap_action_id', '=', 'b.sm_action_id', true], false],
        ]);
        // where
        $this->query->where('AND', ['a.sm_sysflgmap_sysflag_id', '=', $parameters['sysflag_id']]);
    }
