...
class numbers_backend_i18n_basic_model_list_translations extends numbers_frontend_html_list_base {
	...
	public $columns = [
		...
		'lc_translation_id' => ['name' => 'Translation #', 'domain' => 'big_id_sequence', 'width' => '1%'],
		'lc_translation_language_code' => ['name' => 'Language', 'domain' => 'language_code', 'width' => '1%', 'options_model' => 'numbers_backend_i18n_languages_model_languages'],
	...
	public $filter = [
		'lc_translation_id' => ['name' => 'Translation #', 'domain' => 'big_id_sequence', 'range' => true],
		'lc_translation_language_code' => ['name' => 'Language Code', 'domain' => 'language_code', 'method' => 'html::multiselect', 'options_model' => 'numbers_backend_i18n_languages_model_languages'],
