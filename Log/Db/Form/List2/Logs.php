...
class Logs extends \Object\Form\Wrapper\List2 {
	...
	public $elements = [
		...
		self::LIST_CONTAINER => [
			'row1' => [
				'sm_log_id' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Log #', 'domain' => 'uuid', 'percent' => 35],
				'sm_log_message' => ['order' => 2, 'label_name' => 'Message', 'domain' => 'message', 'percent' => 60, 'format' => 'strip', 'format_options' => ['length' => 100]],
				'sm_log_inactive' => ['order' => 3, 'label_name' => 'Inactive', 'type' => 'boolean', 'percent' => 5]
			],
			'row2' => [
				'sm_log_group_id' => ['order' => 1, 'row_order' => 200, 'label_name' => 'Group #', 'domain' => 'uuid', 'percent' => 35],
				'sm_log_type' => ['order' => 2, 'label_name' => 'Type', 'domain' => 'name', 'percent' => 15],
			...
			'row3' => [
				'sm_log_originated_id' => ['order' => 1, 'row_order' => 300, 'label_name' => 'Originated #', 'domain' => 'uuid', 'percent' => 35],
				...
				'sm_log_request_url' => ['order' => 4, 'label_name' => 'Request URL', 'domain' => 'url', 'percent' => 25],
			],
			'row4' => [
