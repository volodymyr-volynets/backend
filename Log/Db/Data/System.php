...
class System extends Import
{
    public $data = [
        'controllers' => [
            ...
            'data' => [
                [
                    'sm_resource_id' => '::id::\Numbers\Backend\Log\Db\Controller\Logs',
                    'sm_resource_code' => '\Numbers\Backend\Log\Db\Controller\Logs',
                    'sm_resource_type' => 100,
                    'sm_resource_classification' => 'Global',
                    'sm_resource_name' => 'S/M Logs',
                    'sm_resource_description' => null,
                    'sm_resource_icon' => 'fa-solid fa-database',
                    'sm_resource_module_code' => 'SM',
                    'sm_resource_group1_name' => 'Operations',
                    'sm_resource_group2_name' => 'System Management',
                    'sm_resource_group3_name' => 'Logs',
                    ...
                    '\Numbers\Backend\System\Modules\Model\Resource\Features' => [
                        [
                            'sm_rsrcftr_feature_code' => 'SM::LOGS_DB',
        ...
        'menu' => [
            ...
            'data' => [
                [
                    'sm_resource_id' => '::id::\Menu\Operations\System\Management\Logs',
                    'sm_resource_code' => '\Menu\Operations\System\Management\Logs',
                    'sm_resource_type' => 299,
                    'sm_resource_name' => 'Logs',
                    'sm_resource_description' => null,
                ...
                [
                    'sm_resource_id' => '::id::\Menu\Numbers\Backend\Log\Db\Controller\Logs',
                    'sm_resource_code' => '\Menu\Numbers\Backend\Log\Db\Controller\Logs',
                    'sm_resource_type' => 200,
                    'sm_resource_name' => 'Logs (Database)',
                    'sm_resource_description' => null,
                    'sm_resource_icon' => 'fa-solid fa-database',
                    'sm_resource_module_code' => 'SM',
                    'sm_resource_group1_name' => 'Operations',
                    ...
                    'sm_resource_acl_authorized' => 0,
                    'sm_resource_acl_permission' => 1,
                    'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Backend\Log\Db\Controller\Logs',
                    'sm_resource_menu_acl_method_code' => 'Index',
                    'sm_resource_menu_acl_action_id' => '::id::List_View',
                    'sm_resource_menu_url' => '/Numbers/Backend/Log/Db/Controller/Logs',
                    'sm_resource_menu_options_generator' => null,
                    'sm_resource_inactive' => 0
                ],
            ]
