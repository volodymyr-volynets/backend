...
class numbers_backend_system_modules_data_system extends object_import {
	public $data = [
		'menu' => [
			'options' => [
				'pk' => ['sm_resource_id'],
			...
			'data' => [
				[
					'sm_resource_id' => '::id::menu_operations_system',
					'sm_resource_code' => 'menu_operations_system',
					'sm_resource_type' => 299,
					'sm_resource_name' => 'System',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'wrench',
				...
				[
					'sm_resource_id' => '::id::menu_operations',
					'sm_resource_code' => 'menu_operations',
					'sm_resource_type' => 299,
